...
namespace Mango.Services.ShoppingCartApi.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        {
            var cartHeaderFromDtb = await _db.CartHeaders.FirstOrDefaultAsync(u => u.UserId == userId);
            if (cartHeaderFromDtb != null)
            {
                _db.CartDetails
                    .RemoveRange(_db.CartDetails.Where(u => u.CartHeaderId == cartHeaderFromDtb.CartHeaderId));
                _db.CartHeaders.Remove(cartHeaderFromDtb);
